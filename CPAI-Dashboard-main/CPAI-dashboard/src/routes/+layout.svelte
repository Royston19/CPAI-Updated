            ...
            <ul class="space-y-2 font-medium">
                <li>
                    ...
                    >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white">List Events</span>
                    </a>
                </li>
                <li>
                    <a
                    ...
                    >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white">Add Event</span>
                    </a>
                </li>
                ...
                <li>
                    ...
                    >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white">List Team</span>
                    </a>
                </li>
                <li>
                    <a
                    ...
                    >
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap text-white">Add Team</span>
                    </a>
                </li>
            </ul>
        </div>
